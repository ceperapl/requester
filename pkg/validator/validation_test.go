...
// 		t.Parallel()
// 		validation, err := New(WithJSONNamesForStructFields())
// 		require.NoError(t, err)
// 		tStruct := testStructure{
// 			Field1: 1,
// 			Field2: "value1",
// 			Field3: "field3",
// 			Field4: "test",
...
// 		require.Error(t, err)
// 		assert.Contains(t, err.Error(), "Key: 'testStruct.Field2' Error:Field validation for 'Field2' failed on the 'oneof' tag. ")
